...
document.addEventListener('DOMContentLoaded', () => {
    // ดักจับ Enter สำหรับการเข้าสู่ระบบ
    ...
    if (loginUser && loginPass) {
        loginUser.addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                loginPass.focus(); // กด Enter ที่ช่องชื่อแล้วเลื่อนไปช่องรหัสผ่าน
            }
        });
        loginPass.addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                window.performLogin(); // กด Enter ที่ช่องรหัสผ่านแล้วเข้าสู่ระบบทันที
            }
        });
    }
